...
from bii_scripts3 import numpy_util
...
class TabFunction:
    ...
    def __init__(self, tab):
        ...
        _tab= numpy.array(sorted(list(tab),key= lambda x:x[0]))
    ...
    def x_limit(self, min_=None, max_=None):
        ...
        _x= numpy.array( [self._x[i] for i in range(min_idx,max_idx+1)] )
        _y= numpy.array( [self._y[i] for i in range(min_idx,max_idx+1)] )
...
class Table:
    ...
    def to_lines(self,sep=" ",formats=None,justifications=None):
    ...
    def __str__(self):
        ...
        3.0 6.0 16.0
        """
        return numpy_util.str_(self._tab)
    def print_(self,sep=" ",formats=None,justifications=None):
        """print the table.
